...
const Catagores = () => {
  ...
  return (
    <div>
      ...
      <div>
        <p className='text-5xl font-bold text-center py-10 mb-10 text-purple-600'>Job Categories</p>
      </div>
      <div className='grid lg:grid-cols-4 grid-cols-2 gap-4'>
        ...
        <div onClick={() => handleCategoryClick('parttime Jobs')} className='border p-5 rounded-xl mx-auto'>
          ...
          <p className='cursor-pointer text-3xl font-bold text-center'>PART-TIME JOBS</p>
        </div>

        {/* Remote Job */}
        <div onClick={() => handleCategoryClick('Remote Job')} className='border p-5 rounded-xl mx-auto'>
          <img className='rounded-xl' src="URL_HERE" alt="" />
          <p className='cursor-pointer text-3xl font-bold text-center'>REMOTE JOB</p>
        </div>

        {/* Hybrid Job */}
        <div onClick={() => handleCategoryClick('Hybrid Job')} className='border p-5 rounded-xl mx-auto'>
          <img className='rounded-xl' src="URL_HERE" alt="" />
          <p className='cursor-pointer text-3xl font-bold text-center'>HYBRID JOBS</p>
        </div>

        {/* Others Jobs */}
        <div onClick={() => handleCategoryClick('onsite Jobs')} className='border p-5 rounded-xl mx-auto'>
          <img className='rounded-xl' src="URL_HERE" alt="" />
          <p className='cursor-pointer text-3xl font-bold text-center'>ONSITES JOBS</p>
        </div>
      </div>
